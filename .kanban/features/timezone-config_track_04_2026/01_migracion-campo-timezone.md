...
- `users.timezone` acepta null (el usuario hereda del tenant)
- `tenants.timezone` tiene default `'UTC'`
- Recrear tablas con `php artisan migrate:fresh` incluye los campos sin pasos adicionales
