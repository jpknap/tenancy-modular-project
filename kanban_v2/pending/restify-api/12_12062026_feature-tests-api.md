...
## Qué hacer
Tests con SQLite in-memory + `RefreshDatabase` + `Sanctum::actingAs()`.
...
- `composer test` verde en los 12+ nuevos tests
- `TenantBleedingTest` confirma aislamiento por schema PostgreSQL
